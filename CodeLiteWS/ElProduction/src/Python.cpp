...
BOOST_PYTHON_MODULE(ElProduction)
{
    ...
    class_<InclusiveElProduction>("InclusiveElProduction", "application class for full inclusive electro production", init<double,double,double,projT,uint>())
        ...
        .def("setLambdaQCD", &InclusiveElProduction::setLambdaQCD, "sets AlphaS_Analytic and its lambda_{QCD,f}")
        .def("setAlphaSByLHAPDF", &InclusiveElProduction::setAlphaSByLHAPDF, "sets Alpha_S by one LHAPDF")
