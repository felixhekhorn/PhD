...
#define cg1SV(proj) cdbl Inclusive::cg1SV##proj(cdbl m2, cdbl q2, cdbl sp, cdbl t1) {\
    cdbl n = Kggg * NC * CF;\
...
#define cg1SVDelta1(proj) cdbl Inclusive::cg1SVDelta1##proj(cdbl m2, cdbl q2, cdbl sp, cdbl t1) {\
    cdbl n = Kggg * NC * CF;\
...
#define cg1SVDelta2(proj) cdbl Inclusive::cg1SVDelta2##proj(cdbl m2, cdbl q2, cdbl sp, cdbl t1) {\
    cdbl n = Kggg * NC * CF;\
...
#define cgBarR1SV(proj) cdbl Inclusive::cgBarR1SV##proj(cdbl m2, cdbl q2, cdbl sp, cdbl t1) {\
    cdbl n = Kggg * NC * CF;\
...
#define cgBarF1SV(proj) cdbl Inclusive::cgBarF1SV##proj(cdbl m2, cdbl q2, cdbl sp, cdbl t1) {\
    cdbl n = Kggg * NC * CF;\
...
#define cgBarF1SVDelta1(proj) cdbl Inclusive::cgBarF1SVDelta1##proj(cdbl m2, cdbl q2, cdbl sp, cdbl t1) {\
    cdbl n = Kggg * NC * CF;\
...
// Hard functions
cdbl Inclusive::cg1HG(cdbl m2, cdbl q2, cdbl sp, cdbl s4, cdbl t1) {
...
cdbl Inclusive::cg1HL(cdbl m2, cdbl q2, cdbl sp, cdbl s4, cdbl t1) {
...
cdbl Inclusive::cg1HP(cdbl m2, cdbl q2, cdbl sp, cdbl s4, cdbl t1) {
...
cdbl Inclusive::cgBarF1HG(cdbl m2, cdbl q2, cdbl sp, cdbl s4, cdbl t1) {
    cdbl nG = 1./(4) * Kggg * NC * CF;
    return (m2/(4.*M_PI)) * nG * (CA * (RPoleGScaleF(m2,q2,sp,s4,t1)))/(sp*sp);
}
cdbl Inclusive::cgBarF1HL(cdbl m2, cdbl q2, cdbl sp, cdbl s4, cdbl t1) {
    cdbl nL = 1./(2) * Kggg * NC * CF;
    return (m2/(4.*M_PI)) * nL * (CA * (RPoleLScaleF(m2,q2,sp,s4,t1)))/(sp*sp);
}
cdbl Inclusive::cgBarF1HP(cdbl m2, cdbl q2, cdbl sp, cdbl s4, cdbl t1) {
    cdbl nP = 1./(2) * Kggg * NC * CF;
