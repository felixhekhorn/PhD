...
cdbl t1c = -1./2.*sp*(1.-beta5*cos(Theta1));
cdbl u1c = -1./2.*(s5-q2)*(1.+beta5*cos(Theta1));
return (m2*Power(sp,3)*(-2 + x))/(Power(t1c,2)*Power(u1c,2)) - (Power(sp,2)*(-4*m2 + u1c)*(-2 + x))/(2.*t1c*Power(u1c,2)) - (2*q2*t1c*(-2 + x))/(sp*u1c*x) - ((-2 + x)*(2*q2 + t1c*x))/(u1c*x) - (sp*(-2 + x)*(q2*u1c + t1c*(-2*m2 + u1c)*x))/(t1c*Power(u1c,2)*x);
}
