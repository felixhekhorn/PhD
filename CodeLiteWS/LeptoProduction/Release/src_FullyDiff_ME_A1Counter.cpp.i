# 1 "src/FullyDiff/ME/A1Counter.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "src/FullyDiff/ME/A1Counter.h" 1



# 1 "src/FullyDiff/ME/../../config.h" 1
# 9 "src/FullyDiff/ME/../../config.h"
...
using std::wcstombs;
using std::wctomb;
# 10 "src/FullyDiff/ME/../../config.h" 2
...
# 11 "src/FullyDiff/ME/../../config.h" 2
...
# 2075 "/usr/include/c++/7/type_traits" 3
 ...
 _Functor, _ArgTypes...
  ...
  template<typename _Functor, typename... _ArgTypes>
    ...
    { };
# 2495 "/usr/include/c++/7/type_traits" 3
  template<typename...> using __void_t = void;
# 2504 "/usr/include/c++/7/type_traits" 3
...
# 12 "src/FullyDiff/ME/../../config.h" 2
...
# 13 "src/FullyDiff/ME/../../config.h" 2
...
# 14 "src/FullyDiff/ME/../../config.h" 2



# 16 "src/FullyDiff/ME/../../config.h"
using namespace std;
...
cdbl dblNaN = nan("");
# 5 "src/FullyDiff/ME/A1Counter.h" 2
...
cdbl A1Counter_F2_AA(cdbl m2, cdbl q2, cdbl sp, cdbl t1, cdbl u1, cdbl tp, cdbl up);
cdbl A1Counter_FL_VV(cdbl m2, cdbl q2, cdbl sp, cdbl t1, cdbl u1, cdbl tp, cdbl up);
cdbl A1Counter_FL_AA(cdbl m2, cdbl q2, cdbl sp, cdbl t1, cdbl u1, cdbl tp, cdbl up);
cdbl A1Counter_x2g1_VV(cdbl m2, cdbl q2, cdbl sp, cdbl t1, cdbl u1, cdbl tp, cdbl up);
cdbl A1Counter_x2g1_AA(cdbl m2, cdbl q2, cdbl sp, cdbl t1, cdbl u1, cdbl tp, cdbl up);

cdbl A1Counter_xF3_VA(cdbl m2, cdbl q2, cdbl sp, cdbl t1, cdbl u1, cdbl tp, cdbl up);
cdbl A1Counter_g4_VA(cdbl m2, cdbl q2, cdbl sp, cdbl t1, cdbl u1, cdbl tp, cdbl up);
cdbl A1Counter_gL_VA(cdbl m2, cdbl q2, cdbl sp, cdbl t1, cdbl u1, cdbl tp, cdbl up);

}

}
# 3 "src/FullyDiff/ME/A1Counter.cpp" 2
...
return (-12*pow(q2,2)*t1c)/(pow(sp,2)*u1c*x) - (12*q2*(q2 + t1c*x))/(sp*u1c*x) + (sp*(-2*x*((-8*m2*q2 + 2*m2*u1c + q2*u1c)*x + t1c*u1c*(2 + (-2 + x)*x)) + 12*pow(beta5,2)*q2*s5*(-1 + x)*pow(cos(Theta2),2)*pow(sin(Theta1),2)))/(t1c*pow(u1c,2)*pow(x,2)) + (pow(sp,2)*(x*(2*m2*(2*m2 + q2)*x - t1c*u1c*(2 + (-2 + x)*x)) + 2*pow(beta5,2)*(2*m2 + q2)*s5*(-1 + x)*pow(cos(Theta2),2)*pow(sin(Theta1),2)))/(pow(t1c,2)*pow(u1c,2)*pow(x,2)) + (-2*x*(pow(q2,2)*u1c + 2*q2*t1c*(-4*m2 + 3*u1c)*x + pow(t1c,2)*u1c*(2 + (-2 + x)*x)) + 12*pow(beta5,2)*q2*s5*t1c*(-1 + x)*pow(cos(Theta2),2)*pow(sin(Theta1),2))/(t1c*pow(u1c,2)*pow(x,2));
}
...
cdbl t1c = -1./2.*sp*(1.-beta5*cos(Theta1));
cdbl u1c = -1./2.*(s5-q2)*(1.+beta5*cos(Theta1));
return (-12*pow(q2,2)*t1c)/(pow(sp,2)*u1c*x) - (12*q2*(q2 + t1c*x))/(sp*u1c*x) + (sp*(3*pow(beta5,2)*q2*s5*(-1 + x) - 2*x*((q2*u1c + 2*m2*(-4*q2 + u1c))*x + t1c*u1c*(2 + (-2 + x)*x)) - 3*pow(beta5,2)*q2*s5*(-1 + x)*(cos(2*Theta1) - 2*cos(2*Theta2)*pow(sin(Theta1),2))))/(t1c*pow(u1c,2)*pow(x,2)) + (pow(sp,2)*(pow(beta5,2)*q2*(2*m2 + q2)*s5*(-1 + x) + 2*x*(4*pow(m2,2)*q2*x - q2*t1c*u1c*(2 + (-2 + x)*x) + 2*m2*(pow(q2,2)*x + 2*t1c*u1c*(2 + (-2 + x)*x))) - pow(beta5,2)*q2*(2*m2 + q2)*s5*(-1 + x)*(cos(2*Theta1) - 2*cos(2*Theta2)*pow(sin(Theta1),2))))/(2.*q2*pow(t1c,2)*pow(u1c,2)*pow(x,2)) + (3*pow(beta5,2)*q2*s5*t1c*(-1 + x) - 2*x*(pow(q2,2)*u1c + 2*q2*t1c*(-4*m2 + 3*u1c)*x + pow(t1c,2)*u1c*(2 + (-2 + x)*x)) - 3*pow(beta5,2)*q2*s5*t1c*(-1 + x)*(cos(2*Theta1) - 2*cos(2*Theta2)*pow(sin(Theta1),2)))/(t1c*pow(u1c,2)*pow(x,2));
}
...
cdbl t1c = -1./2.*sp*(1.-beta5*cos(Theta1));
cdbl u1c = -1./2.*(s5-q2)*(1.+beta5*cos(Theta1));
return (8*pow(q2,2))/(pow(sp,2)*pow(x,2)) + (8*q2)/(sp*x) - (8*q2*(m2*pow(x,2) + pow(beta5,2)*s5*(-1 + x)*pow(cos(Theta2),2)*pow(sin(Theta1),2)))/(t1c*u1c*pow(x,3));
}
...
cdbl t1c = -1./2.*sp*(1.-beta5*cos(Theta1));
cdbl u1c = -1./2.*(s5-q2)*(1.+beta5*cos(Theta1));
return (-8*m2*sp)/(t1c*u1c) + (8*pow(q2,2))/(pow(sp,2)*pow(x,2)) + (8*q2)/(sp*x) - (8*q2*(2*m2*pow(x,2) + pow(beta5,2)*s5*(-1 + x)*pow(cos(Theta2),2)*pow(sin(Theta1),2)))/(t1c*u1c*pow(x,3)) + (4*m2*pow(sp,2)*(x*(2*m2*q2*x + t1c*u1c*(2 + (-2 + x)*x)) + 2*pow(beta5,2)*q2*s5*(-1 + x)*pow(cos(Theta2),2)*pow(sin(Theta1),2)))/(q2*pow(t1c,2)*pow(u1c,2)*pow(x,2));
}
...
cdbl t1c = -1./2.*sp*(1.-beta5*cos(Theta1));
cdbl u1c = -1./2.*(s5-q2)*(1.+beta5*cos(Theta1));
return (2*m2*pow(sp,3)*(-2 + x))/(pow(t1c,2)*pow(u1c,2)) - (pow(sp,2)*(-4*m2 + u1c)*(-2 + x))/(t1c*pow(u1c,2)) - (4*q2*t1c*(-2 + x))/(sp*u1c*x) - (2*(-2 + x)*(2*q2 + t1c*x))/(u1c*x) - (2*sp*(-2 + x)*(q2*u1c + t1c*(-2*m2 + u1c)*x))/(t1c*pow(u1c,2)*x);
}
...
cdbl t1c = -1./2.*sp*(1.-beta5*cos(Theta1));
cdbl u1c = -1./2.*(s5-q2)*(1.+beta5*cos(Theta1));
return (-4*pow(q2,2))/(sp*u1c*x) - (2*q2*(q2 + 2*t1c*x))/(t1c*u1c*x) + (pow(sp,2)*(x*(2*m2*q2*x - t1c*u1c*(2 + (-2 + x)*x)) + 2*pow(beta5,2)*q2*s5*(-1 + x)*pow(cos(Theta2),2)*pow(sin(Theta1),2)))/(pow(t1c,2)*pow(u1c,2)*pow(x,2)) + (sp*(-2*x*(q2*(-2*m2 + u1c)*x + t1c*u1c*(2 + (-2 + x)*x)) + 4*pow(beta5,2)*q2*s5*(-1 + x)*pow(cos(Theta2),2)*pow(sin(Theta1),2)))/(t1c*pow(u1c,2)*pow(x,2));
}
...
cdbl t1c = -1./2.*sp*(1.-beta5*cos(Theta1));
cdbl u1c = -1./2.*(s5-q2)*(1.+beta5*cos(Theta1));
return (-2*m2*pow(sp,3)*(-2 + x))/(pow(t1c,2)*pow(u1c,2)) + (pow(sp,2)*(-4*m2 + u1c)*(-2 + x))/(t1c*pow(u1c,2)) + (4*q2*(-2 + x))/(u1c*x) + (2*sp*(-2 + x)*(q2 + t1c*x))/(t1c*u1c*x);
}
