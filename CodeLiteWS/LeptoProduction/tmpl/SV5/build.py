...
for proj in ["F2_VV", "F2_AA", "FL_VV", "FL_AA","x2g1_VV", "x2g1_AA", "xF3_VA", "g4_VA", "gL_VA"]:
    ...
    tmpl +="""
cdbl FullyDiff::ME::SVOK_%s(cdbl m2, cdbl q2, cdbl sp, cdbl t1, cdbl betaTilde) {{
init
{SV5OK_%s}
return r;
}}

cdbl FullyDiff::ME::SVQED_%s(cdbl m2, cdbl q2, cdbl sp, cdbl t1, cdbl betaTilde) {{
init
{SV5QED_%s}
return r;
}}
