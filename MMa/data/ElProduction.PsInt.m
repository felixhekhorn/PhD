...
psI[u7/s5] = -2*Pi - (2*Pi*(m2 + s4)*u1p*psLog3[S1][s5])/
...
psI[u1/(s5*tp*up)] = (-2*Pi*(m2 + s4)*(2/\[Epsilon] + psLog2[S1][up]))/
      (s4*(s4*sp - q2*(sp + t1))) + (2*Pi*(m2 + s4)*psLog4[S1][tpsp, s5])/
...
psI[u7/up] = -2*Pi - (2*Pi*(m2 + s4)*(sp + u1p)*psLog3[S1][up])/
      (s4*Sqrt[-4*q2*t + (sp + u1p)^2])
...
psI[up/u7] = -2*Pi - (2*Pi*(m2 + s4)*(sp + u1p)*psLog3[S1][u7])/
      (s4*Sqrt[-4*q2*t + (sp + u1p)^2])
...
psI[(u7*up)/(s5*tp)] = 2*Pi - (2*Pi*(-2*m2*sp - (-q2 + sp)*(sp + t1) - 
