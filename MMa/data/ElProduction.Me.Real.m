...
CoeffAG3 = {{{{-4*m2*q2*sp + 2*q2^2*sp + 4*m2*sp^2 + 4*m2*q2*t1 + 6*q2^2*t1 + 
        ...
        -4*m2*q2 + 2*q2^2 + 4*m2*sp - 4*q2*sp + (4*m2*q2^2)/(q2 + sp) - 
         (2*q2^3)/(q2 + sp) + (8*m2*q2*sp)/(q2 + sp) + 
         (2*q2^2*sp)/(q2 + sp) - 4*m2*t1 - 20*q2*t1 + 10*sp*t1 - 
         (4*m2*q2*t1)/(q2 + sp) + (12*q2^2*t1)/(q2 + sp) - 
         (4*m2*sp*t1)/(q2 + sp) - (2*q2*sp*t1)/(q2 + sp) - 
         (2*sp^2*t1)/(q2 + sp) + 18*t1^2 - (18*q2*t1^2)/(q2 + sp) - 
         (2*sp*t1^2)/(q2 + sp) + (8*t1^3)/(q2 + sp) - 4*q2*u1 + 4*sp*u1 + 
         (4*q2^2*u1)/(q2 + sp) - (4*m2*sp*u1)/(q2 + sp) - 
         (2*q2*sp*u1)/(q2 + sp) + 20*t1*u1 - (14*q2*t1*u1)/(q2 + sp) - 
         (4*sp*t1*u1)/(q2 + sp) + (10*t1^2*u1)/(q2 + sp) + 2*u1^2 - 
         (2*q2*u1^2)/(q2 + sp) + (2*t1*u1^2)/(q2 + sp) - 
         (q2^2*\[Epsilon])/2 - (q2*sp*\[Epsilon])/2 + (q2^3*\[Epsilon])/
          (2*(q2 + sp)) + (3*q2^2*sp*\[Epsilon])/(2*(q2 + sp)) - 
         (q2*sp^2*\[Epsilon])/(2*(q2 + sp)) - 2*q2*t1*\[Epsilon] - 
         (2*q2*sp*t1*\[Epsilon])/(q2 + sp) + (q2*u1*\[Epsilon])/2 + 
         (sp*u1*\[Epsilon])/2 - (q2^2*u1*\[Epsilon])/(2*(q2 + sp)) - 
         (2*q2*sp*u1*\[Epsilon])/(q2 + sp) + (sp^2*u1*\[Epsilon])/
          (2*(q2 + sp)) + (t1*u1*\[Epsilon])/2 + (q2*t1*u1*\[Epsilon])/
          (2*(q2 + sp)) + (sp*t1*u1*\[Epsilon])/(2*(q2 + sp)) + 
         (sp*u1^2*\[Epsilon])/(2*(q2 + sp)), 4*m2 - (4*m2*q2)/(q2 + sp) - 
         (4*m2*sp)/(q2 + sp) + 2*t1 + (4*m2*t1)/(q2 + sp) - 
         (2*q2*t1)/(q2 + sp) + (2*t1^2)/(q2 + sp) + (q2*\[Epsilon])/2 - 
         (q2^2*\[Epsilon])/(2*(q2 + sp)) - (u1*\[Epsilon])/2 + 
         (q2*u1*\[Epsilon])/(2*(q2 + sp)) - (t1*u1*\[Epsilon])/
          (2*(q2 + sp))}, {-4*q2*sp + 2*sp^2 - 4*q2*t1 + 6*sp*t1 + 4*t1^2 + 
         2*sp*u1 + 4*t1*u1 - (5*q2*sp*\[Epsilon])/2 + sp^2*\[Epsilon] - 
         q2*t1*\[Epsilon] + sp*t1*\[Epsilon] + sp*u1*\[Epsilon], 
        -2*q2 + 4*sp + (2*q2^2)/(q2 + sp) - (4*m2*sp)/(q2 + sp) + 
         (2*sp^2)/(q2 + sp) + 12*t1 - (6*q2*t1)/(q2 + sp) - 
         (2*sp*t1)/(q2 + sp) + (4*t1^2)/(q2 + sp) + (2*sp*u1)/(q2 + sp) - 
         q2*\[Epsilon] + 2*sp*\[Epsilon] + (q2^2*\[Epsilon])/(q2 + sp) - 
         (q2*sp*\[Epsilon])/(2*(q2 + sp)) + (sp^2*\[Epsilon])/(q2 + sp) + 
         t1*\[Epsilon] - (q2*t1*\[Epsilon])/(q2 + sp) + (sp*t1*\[Epsilon])/
          (q2 + sp) + (sp*u1*\[Epsilon])/(q2 + sp), 
        \[Epsilon] - (q2*\[Epsilon])/(q2 + sp) - (sp*\[Epsilon])/(q2 + sp) + 
         (t1*\[Epsilon])/(q2 + sp)}, {0, 0, 0}}, 
      {{4*m2*sp - 6*q2*sp + 2*sp^2 - 12*q2*t1 + 16*sp*t1 + 16*t1^2 + 
         (4*m2*q2*sp)/u1 + (2*q2^2*sp)/u1 - (2*q2*sp^2)/u1 + 
        ...
        2*q2 + 2*sp - (2*q2^2)/(q2 + sp) - (4*m2*sp)/(q2 + sp) - 
         (10*q2*sp)/(q2 + sp) + (4*sp^2)/(q2 + sp) + 4*t1 + 
         (16*sp*t1)/(q2 + sp) + (8*t1^2)/(q2 + sp) - (8*m2*sp)/u1 - 
         (2*q2*sp)/u1 - (4*m2*q2*sp)/((q2 + sp)*u1) + 
         (2*q2^2*sp)/((q2 + sp)*u1) - (4*m2*sp^2)/((q2 + sp)*u1) - 
         (4*q2*sp^2)/((q2 + sp)*u1) - (4*m2*t1)/u1 - (2*q2*t1)/u1 - 
         (4*sp*t1)/u1 - (4*m2*q2*t1)/((q2 + sp)*u1) - 
         (4*m2*sp*t1)/((q2 + sp)*u1) - (10*q2*sp*t1)/((q2 + sp)*u1) + 
         (4*sp^2*t1)/((q2 + sp)*u1) - (2*t1^2)/u1 - (6*q2*t1^2)/
          ((q2 + sp)*u1) + (10*sp*t1^2)/((q2 + sp)*u1) + 
         (8*t1^3)/((q2 + sp)*u1) - 2*u1 + (2*q2*u1)/(q2 + sp) + 
         (8*sp*u1)/(q2 + sp) - (q2*\[Epsilon])/2 + (3*sp*\[Epsilon])/2 + 
         (q2^2*\[Epsilon])/(2*(q2 + sp)) - (7*q2*sp*\[Epsilon])/
          (2*(q2 + sp)) + (3*sp^2*\[Epsilon])/(2*(q2 + sp)) + 
         3*t1*\[Epsilon] - (q2*t1*\[Epsilon])/(q2 + sp) + 
         (3*sp*t1*\[Epsilon])/(q2 + sp) + (q2^2*\[Epsilon])/(2*u1) - 
         (3*q2*sp*\[Epsilon])/(2*u1) - (q2^3*\[Epsilon])/(2*(q2 + sp)*u1) + 
         (q2^2*sp*\[Epsilon])/(2*(q2 + sp)*u1) - (3*q2*sp^2*\[Epsilon])/
          (2*(q2 + sp)*u1) - (2*q2*t1*\[Epsilon])/u1 - 
         (2*q2*sp*t1*\[Epsilon])/((q2 + sp)*u1) + (3*sp*u1*\[Epsilon])/
          (q2 + sp), (4*m2*sp)/((q2 + sp)*u1) - (2*t1)/u1 + 
         (4*m2*t1)/((q2 + sp)*u1) + (2*q2*t1)/((q2 + sp)*u1) - 
         (2*t1^2)/((q2 + sp)*u1) + \[Epsilon]/2 - (q2*\[Epsilon])/
          (2*(q2 + sp)) + (t1*\[Epsilon])/(q2 + sp) - (q2*\[Epsilon])/
          (2*u1) + (q2^2*\[Epsilon])/(2*(q2 + sp)*u1)}, 
       {8*sp + 10*t1 + (4*m2*sp)/u1 - (2*q2*sp)/u1 + (2*sp^2)/u1 - 
         ...
         (sp*t1*\[Epsilon])/u1, -2 + (2*q2)/(q2 + sp) + (6*sp)/(q2 + sp) - 
         (2*t1)/(q2 + sp) - (2*sp)/u1 - (4*q2*sp)/((q2 + sp)*u1) + 
         (2*t1)/u1 - (2*q2*t1)/((q2 + sp)*u1) + (4*sp*t1)/((q2 + sp)*u1) + 
         (4*t1^2)/((q2 + sp)*u1) + (5*sp*\[Epsilon])/(2*(q2 + sp)) - 
         (sp*\[Epsilon])/u1 - (5*q2*sp*\[Epsilon])/(2*(q2 + sp)*u1) + 
         (t1*\[Epsilon])/u1 - (q2*t1*\[Epsilon])/((q2 + sp)*u1) + 
         (sp*t1*\[Epsilon])/((q2 + sp)*u1), (sp*\[Epsilon])/((q2 + sp)*u1) + 
         (t1*\[Epsilon])/((q2 + sp)*u1)}, {(4*sp)/u1 + (4*t1)/u1 + 
         (sp*\[Epsilon])/u1, (2*sp)/((q2 + sp)*u1) + (sp*\[Epsilon])/
        ...
        (-2*t1)/(q2 + sp) + (2*q2*t1)/((q2 + sp)*u1) - 
         (2*t1^2)/((q2 + sp)*u1) + (sp*\[Epsilon])/(2*(q2 + sp)) - 
         (q2*sp*\[Epsilon])/(2*(q2 + sp)*u1) + (t1*\[Epsilon])/(2*u1) + 
         (q2*t1*\[Epsilon])/(2*(q2 + sp)*u1) + (sp*t1*\[Epsilon])/
          (2*(q2 + sp)*u1), -(t1*\[Epsilon])/(2*(q2 + sp)*u1)}, 
       {(2*t1)/u1 - (sp*\[Epsilon])/(2*u1), (-2*t1)/((q2 + sp)*u1) + 
         (sp*\[Epsilon])/(2*(q2 + sp)*u1), 0}, {0, 0, 0}}}, 
     {{{-8*m2*q2 + 4*q2^2 + 8*m2*sp - 2*q2*sp + 8*m2*t1 - 6*q2*t1 + 4*sp*t1 + 
         ...
         u1^2*\[Epsilon], 12*m2 - 10*q2 - (8*m2*q2)/(q2 + sp) + 
         (6*q2^2)/(q2 + sp) - (4*m2*sp)/(q2 + sp) + (2*q2*sp)/(q2 + sp) + 
         10*t1 + (8*m2*t1)/(q2 + sp) - (20*q2*t1)/(q2 + sp) + 
         (12*t1^2)/(q2 + sp) + 10*u1 - (8*q2*u1)/(q2 + sp) - 
        ...
        (4*m2)/(q2 + sp) + (2*t1)/(q2 + sp) + (q2*\[Epsilon])/(2*(q2 + sp)) - 
         ...
         2*u1*\[Epsilon], 12 - (4*q2)/(q2 + sp) - (4*sp)/(q2 + sp) + 
         (8*t1)/(q2 + sp) + 4*\[Epsilon] - (q2*\[Epsilon])/(q2 + sp) - 
         (sp*\[Epsilon])/(q2 + sp) + (2*t1*\[Epsilon])/(q2 + sp), 
        \[Epsilon]/(q2 + sp)}, {0, 0, 0}}, 
      {{8*m2 - 8*q2 + 2*sp + 10*t1 + (4*m2*q2)/u1 + (2*q2^2)/u1 - 
         ...
         (2*q2*t1*\[Epsilon])/u1 + 3*u1*\[Epsilon], 2 + (2*sp)/(q2 + sp) + 
         (6*t1)/(q2 + sp) - (8*m2)/u1 - (2*q2)/u1 - 
         (4*m2*q2)/((q2 + sp)*u1) + (2*q2^2)/((q2 + sp)*u1) + 
         (4*m2*sp)/((q2 + sp)*u1) - (2*q2*sp)/((q2 + sp)*u1) - (4*t1)/u1 + 
         (8*m2*t1)/((q2 + sp)*u1) - (4*q2*t1)/((q2 + sp)*u1) + 
         (2*sp*t1)/((q2 + sp)*u1) + (4*t1^2)/((q2 + sp)*u1) - 
         (2*u1)/(q2 + sp) + (5*\[Epsilon])/2 - (3*q2*\[Epsilon])/
          (2*(q2 + sp)) + (2*t1*\[Epsilon])/(q2 + sp) - 
        ...
        (-2*t1)/((q2 + sp)*u1) + \[Epsilon]/(2*(q2 + sp)) - 
         ...
         3*\[Epsilon] + (2*t1*\[Epsilon])/u1, -2/(q2 + sp) - 4/u1 - 
         (2*q2)/((q2 + sp)*u1) + (2*sp)/((q2 + sp)*u1) + 
         (4*t1)/((q2 + sp)*u1) - \[Epsilon]/u1 - (2*q2*\[Epsilon])/
          ((q2 + sp)*u1) + (sp*\[Epsilon])/((q2 + sp)*u1) + 
         (2*t1*\[Epsilon])/((q2 + sp)*u1), 0}, {4/u1 + (2*\[Epsilon])/u1, 0, 
        0}}, {{(t1*\[Epsilon])/u1, \[Epsilon]/(q2 + sp) - 
         (q2*\[Epsilon])/((q2 + sp)*u1) + (t1*\[Epsilon])/((q2 + sp)*u1), 0}, 
