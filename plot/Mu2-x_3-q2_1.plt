...
p = "./data/"
f = p."Fc-mu2-x_3-q2_1-MSTW2008nlo90cl-DSSV2014.dat"

mid = system("sed -n \"11p\" '".f."'")

set title "F_2(µ^2)/F_2(µ_0^2) at x=1e-3,Q^2=1e1"
set out "./img/Fc-mu2-x_3-q2_1-2.png"
...
set out "./img/Fc-mu2-x_3-q2_1-L.png"
...
set out "./img/Fc-mu2-x_3-q2_1-P.png"
...
set out "./img/A1-mu2-x_3-q2_1.png"
