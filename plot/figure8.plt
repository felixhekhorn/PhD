...
plot    "./data/cgbar1-q2_-2.dat"  u 1:($2+$5) t "Q²=1e-2", \
	"./data/cgbar1-q2_0.dat"   u 1:($2+$5) t "Q²=1e0" , \
	"./data/cgbar1-q2_1.dat"   u 1:($2+$5) t "Q²=1e1" , \
	"./data/cgbar1-q2_2.dat"   u 1:($2+$5) t "Q²=1e2" , \
	"./data/cgbar1-q2_3.dat"   u 1:($2+$5) t "Q²=1e3" 

set title "Fig. 8. (b): c^{bar,(1)}_{L,g}"
set out "./img/figure8b.png"
plot    "./data/cgbar1-q2_-2.dat"  u 1:($3+$6) t "Q²=1e-2", \
	"./data/cgbar1-q2_0.dat"   u 1:($3+$6) t "Q²=1e0" , \
	"./data/cgbar1-q2_1.dat"   u 1:($3+$6) t "Q²=1e1" , \
	"./data/cgbar1-q2_2.dat"   u 1:($3+$6) t "Q²=1e2" , \
	"./data/cgbar1-q2_3.dat"   u 1:($3+$6) t "Q²=1e3" 

set title "Fig. 8. (p): Δc^{bar,(1)}_{g}"
set out "./img/figure8p.png"
plot    "./data/cgbar1-q2_-2.dat"  u 1:($4+$7) t "Q²=1e-2", \
	"./data/cgbar1-q2_0.dat"   u 1:($4+$7) t "Q²=1e0" , \
	"./data/cgbar1-q2_1.dat"   u 1:($4+$7) t "Q²=1e1" , \
	"./data/cgbar1-q2_2.dat"   u 1:($4+$7) t "Q²=1e2" , \
	"./data/cgbar1-q2_3.dat"   u 1:($4+$7) t "Q²=1e3" 
...
plot    "./data/cgbar1-q2_-2.dat"  u 1:6 t "Q²=1e-2", \
	"./data/cgbar1-q2_0.dat"   u 1:6 t "Q²=1e0" , \
	"./data/cgbar1-q2_1.dat"   u 1:6 t "Q²=1e1" , \
	"./data/cgbar1-q2_2.dat"   u 1:6 t "Q²=1e2" , \
	"./data/cgbar1-q2_3.dat"   u 1:6 t "Q²=1e3" 

set title "Fig. 8\\@R. (p): Δc^{bar,R,(1)}_{g}"
set out "./img/figure8Rp.png"
plot    "./data/cgbar1-q2_-2.dat"  u 1:7 t "Q²=1e-2", \
	"./data/cgbar1-q2_0.dat"   u 1:7 t "Q²=1e0" , \
	"./data/cgbar1-q2_1.dat"   u 1:7 t "Q²=1e1" , \
	"./data/cgbar1-q2_2.dat"   u 1:7 t "Q²=1e2" , \
	"./data/cgbar1-q2_3.dat"   u 1:7 t "Q²=1e3" 
