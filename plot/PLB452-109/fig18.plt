...
f10 = pin . "dFLb_dDphi_x-42_q2-120_1.dat"
f11 = pin . "dFLb_dDphi_x-85_q2-120_1.dat"
f12 = pin . "dFLb_dDphi_x-160_q2-120_1.dat"
f13 = pin . "dFLb_dDphi_x-270_q2-120_1.dat"

f01 = pin . "dFLb_dDphi_x-85_q2-85_1.dat"
f21 = pin . "dFLb_dDphi_x-85_q2-250_1.dat"
f31 = pin . "dFLb_dDphi_x-85_q2-500_1.dat"

x1(l,r) = .5*l+.5*r

set title sprintf("Fig. 18a) dF_L(x,Q²=12GeV²,m_b²,Δϕ)/d(Δϕ) with %s",pdf)
set out pout . "fig18a.png"
...
set title sprintf("Fig. 18b) dF_L(x=8.5e-4,Q²,m_b²,Δϕ)/d(Δϕ) with %s",pdf)
set out pout . "fig18b.png"
