...
plot    "./data/F2Lc-q2_1-cteq.dat"  u 1:3 t "Q²=1e1",\
        "./data/F2Lc-q2_2-cteq.dat"  u 1:3 t "Q²=1e2"

set title "Fig. 15. (a): F^{(1)}_{2,g}(x,Q²,m_c^2) MSTW2008NNLO"
set out "./img/figure15a-mstw.png"
plot    "./data/F2Lc-q2_1-mstw.dat"  u 1:3 t "Q²=1e1",\
        "./data/F2Lc-q2_2-mstw.dat"  u 1:3 t "Q²=1e2"
