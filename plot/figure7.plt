...
#set yrange [-.3:1.3]
plot    "./data/cg1-q2_-2.dat"  u 1:2 t "Q²=1e-2", \
	"./data/cg1-q2_0.dat"   u 1:2 t "Q²=1e0" , \
	"./data/cg1-q2_1.dat"   u 1:2 t "Q²=1e1" , \
...
#set yrange [-.03:.16]
plot    "./data/cg1-q2_-2.dat"  u 1:3 t "Q²=1e-2", \
	"./data/cg1-q2_0.dat"   u 1:3 t "Q²=1e0" , \
