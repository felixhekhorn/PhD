...
plot f_10_0  u (.5*$1+.5*$2):($3/($2-$1)/n*nbTimesGeV2)    t "GRSV96STDLO,  √S=10GeV,   LO",\
     f_10_1  u (.5*$1+.5*$2):($3/($2-$1)/n*nbTimesGeV2)    t "GRSV96STDNLO, √S=10GeV,  NLO",\
     f_200_0 u (.5*$1+.5*$2):($3/($2-$1)/n/8.*nbTimesGeV2) t "GRSV96STDLO,  √S=200GeV,  LO",\
     f_200_1 u (.5*$1+.5*$2):($3/($2-$1)/n/8.*nbTimesGeV2) t "GRSV96STDNLO, √S=200GeV, NLO"
