...
plot    "./data/F2Lc-q2_1-mtb.dat"  u 1:(($2+$1*($3+$4))/$2) t "Q²=1e1, µ²=µ_0^2",\
        "./data/F2Lc-q2_2-mtb.dat"  u 1:(($2+$1*($3+$4))/$2) t "Q²=1e2, µ²=µ_0^2"
...
plot    "./data/F2Lc-q2_1-mtb.dat"  u 1:(($5+$1*($6+$7))/$5) t "Q²=1e1, µ²=µ_0^2",\
        "./data/F2Lc-q2_2-mtb.dat"  u 1:(($5+$1*($6+$7))/$5) t "Q²=1e2, µ²=µ_0^2"
