...
p = "./data/"
f = p."Fc-mu2-x_1-q2_2-MSTW2008nlo90cl-DSSV2014.dat"

mid = system("sed -n \"11p\" '".f."'")

set title "F_2(µ^2)/F_2(µ_0^2) at x=1e-1,Q^2=1e2"
set out "./img/Fc-mu2-x_1-q2_2-2.png"
plot    f  u 1:(($2)/word(mid,2)) w l t "LO",\
        f  u 1:(($2+$3+$4)/(word(mid,2)+word(mid,3)+word(mid,4))) w l t "NLO"

set title "F_L(µ^2)/F_L(µ_0^2) at x=1e-1,Q^2=1e2"
set out "./img/Fc-mu2-x_1-q2_2-L.png"
plot    f  u 1:(($5)/word(mid,5)) w l t "LO",\
        f  u 1:(($5+$6+$7)/(word(mid,5)+word(mid,6)+word(mid,7))) w l t "NLO"

set title "g_1(µ^2)/g_1(µ_0^2) at x=1e-1,Q^2=1e2"
set out "./img/Fc-mu2-x_1-q2_2-P.png"
...
set title "A_1(µ^2)/A_1(µ_0^2) at x=1e-1,Q^2=1e2"
set out "./img/A1-mu2-x_1-q2_2.png"
