...
p = "./data/"
f = p."Fc-x_1-q2_2-MSTW2008nlo90cl-DSSV2014.dat"

mid = system("sed -n \"11p\" '".f."'")

set title "F_2(µ^2)/F_2(µ_0^2) at x=1e-1,Q^2=1e2"
set out "./img/Fc-x_1-q2_2-mu2.png"
...
set out "./img/Fc-x_1-q2_2-muL.png"
...
set out "./img/Fc-x_1-q2_2-muP.png"
...
set out "./img/A1-x_1-q2_2-mu.png"
