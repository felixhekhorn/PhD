...
plot    "./data/F2Lc-q2_1-ct14.dat"  u 1:($2) w l t "Q²=1e1, LO",\
        "./data/F2Lc-q2_1-ct14.dat"  u 1:($2+$1*($3+$4)) w l t "Q²=1e1, LO+NLO",\
        "./data/F2Lc-q2_2-ct14.dat"  u 1:($2) w l t "Q²=1e2, LO",\
        "./data/F2Lc-q2_2-ct14.dat"  u 1:($2+$1*($3+$4)) w l t "Q²=1e2, LO+NLO"
...
plot    "./data/F2Lc-q2_1-mtb.dat"  u 1:5 w l t "Q²=1e1, LO",\
        "./data/F2Lc-q2_1-mtb.dat"  u 1:($5+$6+$7) w lines t "Q²=1e1, LO+NLO",\
        "./data/F2Lc-q2_2-mtb.dat"  u 1:5 w l t "Q²=1e2, LO",\
        "./data/F2Lc-q2_2-mtb.dat"  u 1:($5+$6+$7) w lines t "Q²=1e2, LO+NLO"

set title "Fig. 14. (b): xF_{L}(x,Q²,m_c^2) CT14"
set out "./img/figure14b-ct14.png"
plot    "./data/F2Lc-q2_1-ct14.dat"  u 1:($5) w l t "Q²=1e1, LO",\
        "./data/F2Lc-q2_1-ct14.dat"  u 1:($5+$1*($6+$7)) w lines t "Q²=1e1, LO+NLO",\
        "./data/F2Lc-q2_2-ct14.dat"  u 1:($5) w l t "Q²=1e2, LO",\
        "./data/F2Lc-q2_2-ct14.dat"  u 1:($5+$1*($6+$7)) w lines t "Q²=1e2, LO+NLO"
