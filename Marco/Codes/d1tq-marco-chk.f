      ...
      integer n2,n3,n1
      dimension qq(4)
      data qq/1.d0,10.d0,100.d0,1000.d0/
C      
      m2=4.75d0*4.75d0
C
      do 100 n1=1,4
      ...
      DO 1000 N2=-3,3,1
         DO 2000 N3=2,18,1
c
            ETA=DBLE(N3)*0.5D0*10.D0**N2 !LOOP OVER ETA VALUES
            IF(ETA.GT.1001.D0) GOTO 2000
            CALL subd1tq(eta,xi,d1lq)
            write(6,11) eta,q2,d1lq*2.d0/3.d0
 11         format(6(1pe12.4,1x))
