...
Print["       (UNPOLARIZED - L PROJECTION)"]
Print["==================================================="]
Print[" "]
...
me1=((<<pgm1m1-unp-l) + <<pgm2m2-unp-l + <<pgm3m3-unp-l + <<pgm4m4-unp-l + <<pgm5m5-unp-l + <<pgm6m6-unp-l)*c1+
    (<<pgm1m4-unp-l + <<pgm1m5-unp-l)*2*c1+
    (<<pgm1m2-unp-l + <<pgm1m3-unp-l + <<pgm1m6-unp-l)*2*c2+
    (<<pgm2m3-unp-l + <<pgm2m6-unp-l)*2*c1+
    (<<pgm2m4-unp-l + <<pgm2m5-unp-l)*2*c2+
    (<<pgm3m6-unp-l)*2*c1+
    (<<pgm3m4-unp-l + <<pgm3m5-unp-l)*2*c2+
    (<<pgm4m5-unp-l)*2*c1+
    (<<pgm4m6-unp-l)*2*c2+
    (<<pgm5m6-unp-l)*2*c2
