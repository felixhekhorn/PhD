...
c     do 300 n2=1,9,1
         n2=1
            ...
            CALL VEGAS(cgsvqed,1.d-6,1,10000,6,0,0)
 ...
 100  continue
      ...
      END
c ***
      double precision function cgsvqed(x)
      implicit double precision (a-z)
      dimension x(10)
      common/par/eta
      pi = 3.1415926d0
...
c      jacob = (mt1up-mt1do) * (mu1up-mu1do)
      u1 = -s-t1
      jacob = (mt1up - mt1do)
      cgsvqed = m2/s**2/4/pi * jacob * svqed(s,t1,u1,m)
      return
      end
c ***
