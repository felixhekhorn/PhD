...
cf2py double precision intent(in) :: T1,SP,M2,Q2
C
...
cf2py double precision intent(in) :: X,Y,M2,Q2,S,SP,T1,U1,TP,UP,S3,S4,S5,U6,U7,DP,DM
C
...
cf2py double precision intent(in) :: T1,SP,M2,Q2,RHOTILDE
C
