...
\begin{align}
PS_2 &= \int \!\frac{d^np_1}{(2\pi)^{n-1}}\frac{d^np_1}{(2\pi)^{n-1}} \delta^{(4)}(q+k_1-p_1-p_2)\delta(p_1^2-m^2)\delta(p_2^2 - m^2)\\
 ...
 &= \frac \pi {(2\pi)^{n-2} 2\sqrt s}\int\!dp_{1,||}dp^2_{1,\perp}d^{n-4}\hat p_1\,\delta(p_{1,0}^2-p_{1,||}^2 - p_{1,\perp}^2 - \hat p_1^2-m^2)\\
...
\begin{equation}
dp_{1,||} = \frac{\sqrt 2} 2 \beta\,d\!\cos\theta \qquad \cos\theta\in[-1,1],\, \hat p_1^2 \in \frac{s \beta^2}{4}\left(1-\cos^2\theta\right)\cdot[0,1]
\end{equation}
