We study the neutral-current (NC) deep inelastic scattering (DIS) reaction
\begin{equation}
...
We use the framework of the collinear factorization, so the leading order partonic reaction is given by
\begin{equation}
