...
\end{equation}
For convenience we also define $s' = s-q^2$ and $u_1' = u_1 - q^2$. If the heavy \textit{quark} $\PQ(p_1)$ is detected, $p_2$ in eq. (\ref{eq:LOst1u1}) has to be replaced by $p_1$ which effectively interchanges $t_1\leftrightarrow u_1$.\fxerror{move to LO?}
