...
vnu2 = Vertex(2, 2, mark=CIRCLE).addLabel(r"$\nu_2,b$",displace=.3,angle=70)
vnu1 = Vertex(2, 0, mark=CIRCLE).addLabel(r"$\nu_1,b$",displace=.3,angle=-40)
...
Fermion(vmu,vnuQ).addStyle(pyx.style.linewidth(0.05*pyx.unit.w_cm)).addArrow()\
	.addParallelArrow(size=0.1, displace=0.06).addLabel(r"$l+p_1-k_1$",angle=90,displace=.9)
