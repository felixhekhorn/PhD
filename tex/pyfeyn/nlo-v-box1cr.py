...
vnu1 = Vertex(2.7, 2, mark=CIRCLE).addLabel(r"$\nu_1,b$",displace=.3,angle=90)
vnu2 = Vertex(2.7, 0, mark=CIRCLE).addLabel(r"$\nu_2,b$",displace=.3,angle=-90)
vnu1p = Vertex(1.2, 2)
vnu2p = Vertex(1.2, 0)
...
Fermion(vnu1,vnu1p).addStyle(pyx.style.linewidth(0.05*pyx.unit.w_cm)).addArrow()\
	.addParallelArrow(size=0.1, displace=0.06,pos=.7).addLabel(r"$l-p_2$",displace=.26,pos=.7)
Fermion(vnu1p,vnuQ).addStyle(pyx.style.linewidth(0.05*pyx.unit.w_cm)).addArrow(position=.3)
Fermion(vnuQ,vmu).addStyle(pyx.style.linewidth(0.05*pyx.unit.w_cm)).addArrow()\
	.addParallelArrow(size=0.1, displace=-0.06).addLabel(r"$l+k_1-p_2$",angle=90,displace=-.9)
Fermion(vmu,vnu2p).addStyle(pyx.style.linewidth(0.05*pyx.unit.w_cm)).addArrow(position=.7)
Fermion(vnu2p,vnu2).addStyle(pyx.style.linewidth(0.05*pyx.unit.w_cm)).addArrow()\
