...
Fermion(vmu,vnuq).addArrow()\
	.addParallelArrow(size=0.1, displace=0.06, sense=1).addLabel(r"$q+k_1$",displace=.25)
...
Gluon(vnuq,vnuQ)\
	.addParallelArrow(size=0.1, displace=-0.06, sense=1).addLabel(r"$p_1+p_2$",displace=-.6,pos=.3)
