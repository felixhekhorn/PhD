...
\newcolumntype{w}{>{\centering\arraybackslash} m{.62\linewidth} }
\newcolumntype{n}{>{\centering\arraybackslash} m{.38\linewidth} }
...
\begin{tabular}{wn}
\begin{center}
\only<1>{\includegraphics[height=.97\textheight]{img/A1-pdf}}
\only<2>{\includegraphics[height=.97\textheight]{img/A1-pdf-data}}
\end{center} & 
\begin{itemize}
