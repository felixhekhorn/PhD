...
set label 1 "c_{P,q}^{(1)}(η)" at graph 0.1,0.9 font ",18"
...
plot    0 t "" w lines ls 4,\
	p."cq1-q2_-2.dat"  u 1:4 t "" w linespoints ls 1 pi -10 pt 5 lc rgb "#aa0000", \
	p."cq1-q2_-2.dat"  u 1:4 t "Q^2 = 10^{-2} GeV^2" w lines ls 1 lc rgb "#aa0000", \
        p."cq1-q2_2.dat"   u 1:4 t "" w linespoints ls 2 pi -10 pt 5 lc rgb "#00aa00", \
        p."cq1-q2_2.dat"   u 1:4 t "Q^2 = 10^{2} GeV^2" w lines ls 2 lc rgb "#00aa00", \
	p."cq1-q2_3.dat"   u 1:4 t "" w linespoints ls 3 pi -10 pt 5 lc rgb "#0000aa", \
	p."cq1-q2_3.dat"   u 1:4 t "Q^2 = 10^{3} GeV^2" w lines ls 3 lc rgb "#0000aa"     
...
#set ytics format "%.2f"
plot    0 t "" w lines ls 4,\
	p."cqBarF1-q2_-2.dat"  u 1:4 t "" w linespoints ls 1 pi -10 pt 5 lc rgb "#aa0000", \
        p."cqBarF1-q2_2.dat"   u 1:4 t "" w linespoints ls 2 pi -10 pt 5 lc rgb "#00aa00", \
        p."cqBarF1-q2_3.dat"   u 1:4 t "" w linespoints ls 3 pi -10 pt 5 lc rgb "#0000aa"
...
#set ytics format "%.2f"
plot    0 t "" w lines ls 4,\
	p."dq1-q2_-2.dat"  u 1:4 t "" w linespoints ls 1 pi -10 pt 5 lc rgb "#aa0000", \
        p."dq1-q2_2.dat"   u 1:4 t "" w linespoints ls 2 pi -10 pt 5 lc rgb "#00aa00", \
        p."dq1-q2_3.dat"   u 1:4 t "" w linespoints ls 3 pi -10 pt 5 lc rgb "#0000aa"
