...
\item compare unpolarized case HERA@DESY: at small $x$ $\sim 30\%$ charm contributions \iRef{Laenen,Riemersma,Smith,van Neerven}
\item<2-> measure $\Delta \Pg$ as dominated by photon-gluon fusion (PGF)
\item<2-> first full NLO computation of polarized process \iRef{Blümlein,Falcioni,De Freitas} \iRef{Buza,Matiounine,Smith,van Neerven} \iRef{Bojak,Stratmann} \iRef{Vogelsang}
\end{itemize}
\begin{itemize}
...
\item unpolarized cross section: \iRef{PDG}\\
...
\item polarized cross section: \iRef{PDG}\\
